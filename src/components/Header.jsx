        ...
        <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
          ...
          <li>
            <Link to="/admin" className="sidebar-link">
              <FiSliders className="sidebar-icon" /> Servicios
            </Link>
          </li>
          <li>
            <Link to="/admin/perfil" className="sidebar-link">
              <FiUser className="sidebar-icon" /> Perfil
            </Link>
          </li>
          <li>
            <Link to="/admin/listado" className="sidebar-link">
              <FiList className="sidebar-icon" /> Listado Servicios
            </Link>
          </li>
          <li>
            <Link to="/admin/listado-citas" className="sidebar-link">
              <FiList className="sidebar-icon" /> Listado Citas
            </Link>
          </li>
          <li>
            <button
